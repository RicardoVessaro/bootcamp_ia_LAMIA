...
- `recomendacao_musicas_pratica`: Cria o modelo de recomendação utilizando KNN, normalizando os dados de pontuação e calculando a distância dos vetores de gêneros, esses dados são utilizados para recomendar músicas com base na música escolhida com a opção de repetir o artista ou não.
