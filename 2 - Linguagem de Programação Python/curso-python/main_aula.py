...
# from funcoes import args_aula

# Nos quatro casos é recebido uma tupla como parâmetro.
# args_aula.soma()
# args_aula.soma(1)
# args_aula.soma(1, 2, 3)
# A função `args_aula.soma` recebe parâmetros posicionais
# Transformar os argumentos em uma tupla se chama pack (empacotar)
# s = args_aula.soma(1, 2, 3, 7, 8, 9, 10)
# print(s) # mostra: 40

# Quando uma função não retorna nada é atribuído o valor None na váriavel.
# Transformar os argumentos em um dicionário também se chama pack (empacotar)
# resultado = args_aula.resultado_final(nome='Pedro', nota=7.3)
# print(resultado) # mostra: Pedro foi aprovado(a)
# resultado = args_aula.resultado_final(nome='Pedro', nota=6.3)
# print(resultado) # mostra: Pedro foi reprovado(a)

# from funcoes import funcional_aula
# import funcoes.map_reduce_aula
# import funcoes.lambdas_aula
# import funcoes.comprehension_aula

# import oo.produto_aula
# import oo.heranca_aula
import oo.membros_aula
